...
const OrganizationRolePage = () => {
    ...
    return (
        <div>
            <Card className='bg-gray-800 border-gray-700 mb-4 overflow-hidden'>
                ...
                <CardContent className='space-y-4 pt-6 -mt-4'>
                    <div onClick={() => navigate('/ip-form')}>
                        <div>
                            <User className='h-6 w-6 text-cyan-400' />
                        </div>
                        <div>
                            <p className='font-bold text-xl text-white'>ИП</p>
                            <p className='text-blue-100'>Индивидуальный предприниматель</p>
                        </div>
                    </div>
                    <div className='flex items-center gap-3' onClick={() => navigate('/ooo-form')}>
                        ...
                        <div>
                            ...
                            <p className='text-blue-100'>Общество с ограниченной ответственностью</p>
                        </div>
                    </div>
                    <div onClick={() => navigate('/self-employed-form')}>
                        <div>
                            <User className='h-6 w-6 text-cyan-400' />
                        </div>
                        <div>
                            <p className='font-bold text-xl text-white'>Самозанятый</p>
                            <p className='text-blue-100'>Плательщик налога на профессиональный доход</p>
                        </div>
                    </div>
                </CardContent>
            </Card>
