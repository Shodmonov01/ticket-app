        ...
        <div className="fixed inset-0 bg-gray-900 text-white flex flex-col overflow-y-auto z-50">
            ...
            <div className="px-4 py-6">
                ...
                <p className="mt-2 text-sm">
                    {fullDescription ? event.descr : `${event.descr.slice(0, 200)}...`}
                </p>
                <button
            ...
            <div className="px-4 py-6">
                ...
                <p className="mt-2 text-sm">
                    📅 Date: Sunday & Thursdays (select your date below)<br />
                    🕒 Time: 3:30 p.m.<br />
                    ⏳ Duration: 3.5 hours<br />
                    📍 Meeting point: The Swiss Clock in Leicester Square next to the M&M's store<br />
                ...
                <div className="mt-4 flex space-x-2 overflow-x-auto">
                    {appState.timeline.map(time => (
                        <button
                            ...
                            className={`px-4 py-2 rounded-lg border ${selectedTimeline === time ? "border-blue-500 text-blue-500" : "border-gray-600 text-white"}`}
                        >
                            {time}
                        </button>
                    ))}
            ...
            <div className="px-4 py-6">
                <div className="bg-yellow-900/20 rounded-lg p-4 flex items-start">
                    ...
                    <div className="ml-3">
                        ...
                        <p className="text-sm text-yellow-600">Tickets are in high demand and availability is limited.</p>
                    </div>
                </div>
            </div>
